  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <header className="sticky top-0 z-50 flex h-14 items-center border-b border-border/40 bg-background/95 px-6 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        ...
        {/* Submit CTA — pushed to the right */}
        <div className="ml-auto">
          <Link
            href="/submit"
            className="flex items-center gap-2 bg-sentinel-blue/10 text-sentinel-blue px-3 py-1.5 rounded-md text-sm font-medium hover:bg-sentinel-blue/20 transition-colors border border-sentinel-blue/25"
          >
